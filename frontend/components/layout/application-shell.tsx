...
export function ApplicationShell({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell">
    ...
    <aside className={cn("sidebar", isMenuOpen && "sidebar-open")} aria-label="Primary navigation">
      ...
      <div className="profile"><div className="avatar">WA</div><div><strong>Wagai Admin</strong><span>Administrator</span></div><button className="logout" type="button">Log out</button></div>
    </aside>
